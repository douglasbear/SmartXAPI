...
{
    public partial class VwVsaDashBoardAppointment
    {
        [Column("N_CompanyID")]
        ...
        [Column("App_N_RefID")]
        public int AppNRefId { get; set; }
        [Column("App_N_LocationID")]
        public int AppNLocationId { get; set; }
        [Column("App_D_Date")]
        [StringLength(8000)]
        public string AppDDate { get; set; }
        [Column("App_T_Time", TypeName = "time(5)")]
        public TimeSpan? AppTTime { get; set; }
        [Column("App_T_TimeTo", TypeName = "time(5)")]
        public TimeSpan? AppTTimeTo { get; set; }
        [Column("App_X_Description")]
        [StringLength(250)]
        public string AppXDescription { get; set; }
        [Column("App_N_RefTypeID")]
        [StringLength(10)]
        public string AppNRefTypeId { get; set; }
        [Column("App_X_UserID")]
        [StringLength(50)]
        public string AppXUserId { get; set; }
        [Column("App_N_UserID")]
        public int? AppNUserId { get; set; }
