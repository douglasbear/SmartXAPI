...
{
    [Table("Inv_SalesQuotationDetails")]
    public partial class InvSalesQuotationDetails
    {
        [Column("N_CompanyID")]
        ...
        [Column("N_PurchaseCost", TypeName = "decimal(20, 6)")]
        public decimal? NPurchaseCost { get; set; }
        [Column("X_MinMarginPerc")]
        [StringLength(50)]
        public string XMinMarginPerc { get; set; }
    }
}
