...
{
    [Table("Acc_VoucherDetails")]
    public partial class AccVoucherDetails
    {
        [Key]
        [Column("N_CompanyID")]
        ...
        [InverseProperty(nameof(AccMastLedger.AccVoucherDetails))]
        public virtual AccMastLedger N { get; set; }
        [ForeignKey(nameof(NFnYearId))]
        [InverseProperty(nameof(AccFnYear.AccVoucherDetails))]
