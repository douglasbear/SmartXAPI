...
namespace SmartxAPI.Models
{
    ...
    public partial class InvCustomer
    {
        public InvCustomer()
        {
            ...
            InvSalesOrder = new HashSet<InvSalesOrder>();
            InvSalesReturnMaster = new HashSet<InvSalesReturnMaster>();
        }
        ...
        [InverseProperty("N")]
        public virtual ICollection<InvSalesOrder> InvSalesOrder { get; set; }
        [InverseProperty("N")]
        public virtual ICollection<InvSalesReturnMaster> InvSalesReturnMaster { get; set; }
    }
}
