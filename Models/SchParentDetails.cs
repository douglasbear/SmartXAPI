...
{
    [Table("Sch_ParentDetails")]
    public partial class SchParentDetails
    {
        public SchParentDetails()
        {
        ...
        [Column("I_FatherImage", TypeName = "image")]
        public byte[] IFatherImage { get; set; }
        [Column("I_MotherImage", TypeName = "image")]
        public byte[] IMotherImage { get; set; }
        [Column("X_ParentCode")]
        [StringLength(100)]
        ...
        [Column("N_StreetNo")]
        public int? NStreetNo { get; set; }
        [Column("N_ZoneNo")]
        public int? NZoneNo { get; set; }

        [InverseProperty("NParent")]
