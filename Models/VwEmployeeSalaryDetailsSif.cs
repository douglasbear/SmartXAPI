...
{
    public partial class VwEmployeeSalaryDetailsSif
    {
        [Column("N_CompanyID")]
        ...
        [Column(TypeName = "money")]
        public decimal? OtherFixedSalary { get; set; }
        [Column("N_VariableIncome", TypeName = "money")]
        public decimal? NVariableIncome { get; set; }
        [Column("N_OtherVariableIncome", TypeName = "money")]
        public decimal? NOtherVariableIncome { get; set; }
        [Column("X_PayrunText")]
        [StringLength(50)]
