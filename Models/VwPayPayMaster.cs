...
{
    public partial class VwPayPayMaster
    {
        [Column("N_CompanyID")]
        ...
        [Column("X_SystemTypeName")]
        [StringLength(50)]
        public string XSystemTypeName { get; set; }
        ...
        [Column("X_TaxDisplayName")]
        [StringLength(100)]
        public string XTaxDisplayName { get; set; }
        ...
        [Column("X_IncomeCode")]
        [StringLength(50)]
        public string XIncomeCode { get; set; }
        [Column("X_IncomeName")]
        [StringLength(500)]
        public string XIncomeName { get; set; }
        [Column("X_ExpenseCode")]
        [StringLength(50)]
        public string XExpenseCode { get; set; }
        [Column("X_ExpenseName")]
        [StringLength(500)]
        public string XExpenseName { get; set; }
        ...
        [Column("X_AmrIncCode")]
        [StringLength(50)]
        public string XAmrIncCode { get; set; }
        [Column("X_AmrIncName")]
        [StringLength(500)]
        public string XAmrIncName { get; set; }
        [Column("X_AmrExpCode")]
        [StringLength(50)]
        public string XAmrExpCode { get; set; }
        [Column("X_AmrExpName")]
        [StringLength(500)]
        public string XAmrExpName { get; set; }
    }
}
