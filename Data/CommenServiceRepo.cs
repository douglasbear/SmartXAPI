                    ...
                    switch (reqtype.ToLower())
                    {
                        ...
                        case "vendor":
                            ...
                            using (SqlConnection cnn2 = new SqlConnection(masterDBConnectionString))
                            {
                                ...
                                string sqlGUserInfo = "SELECT Users.N_UserID, Users.X_EmailID, Users.X_UserName, Users.N_ClientID, Users.N_ActiveAppID, ClientApps.X_AppUrl,ClientApps.B_EnableAttachment,ClientApps.X_DBUri, AppMaster.X_AppName, ClientMaster.X_AdminUserID AS x_AdminUser,users.N_LanguageID, CASE WHEN Users.N_UserType=0 THEN 1 ELSE 0 end as isAdminUser,Users.X_UserID,isnull(ClientMaster.N_TwoFactAuthType,1) as N_TwoFactAuthType,isnull(ClientMaster.B_EnableWhatsappAuth,0) as B_EnableWhatsappAuth ,isnull(ClientMaster.B_EnableEmailAuth,1) as B_EnableEmailAuth,isnull(Users.B_EnableTwoFactAuth,0) as B_EnableTwoFactAuth,isnull(Users.B_ByPassTwoFactAuth,0) as B_ByPassTwoFactAuth FROM Users LEFT OUTER JOIN ClientMaster ON Users.N_ClientID = ClientMaster.N_ClientID LEFT OUTER JOIN ClientApps ON Users.N_ActiveAppID = ClientApps.N_AppID AND Users.N_ClientID = ClientApps.N_ClientID LEFT OUTER JOIN AppMaster ON ClientApps.N_AppID = AppMaster.N_AppID WHERE (Users.X_UserID ='" + username + "')";
