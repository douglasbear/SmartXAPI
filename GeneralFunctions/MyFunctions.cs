...
namespace SmartxAPI.GeneralFunctions
{
   ...
   public int LogApprovals(DataTable Approvals, int N_FnYearID, string X_TransType, int N_TransID, string X_TransCode, int GroupID, string PartyName, int EmpID, string DepLevel, ClaimsPrincipal User, IDataAccessLayer dLayer, SqlConnection connection, SqlTransaction transaction)
        ...
        public bool SendMailWithAttachments(int nFormID,int nFnYearID,int nPkeyID,string partyName,string xType,string docNumber, string mail,string xBody,IDataAccessLayer dLayer,ClaimsPrincipal User)
        {
    ...
    public interface IMyFunctions
    {
        ...
        public bool SendMailWithAttachments(int nFormID,int nFnYearID,int nPkeyID,string partyName,string xType,string docNumber, string mail,string url,IDataAccessLayer dLayer,ClaimsPrincipal User);
    }
}