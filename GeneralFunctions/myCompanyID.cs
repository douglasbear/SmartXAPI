...
namespace SmartxAPI
{
    static class myCompanyID
    {
        ...
        public static EventHandler mnuTool_Click;
        public static EventHandler mnuToolQuickAccess_Click;
        public static EventHandler mnuToolSideMenu_Click;
        public static EventHandler mnuToolLabel_MouseLeave;
        public static EventHandler mnuToolLabel_MouseHover;
        public static DataSet _dsPayroll = new DataSet();
