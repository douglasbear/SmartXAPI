    ...
    public class EssDashboard : ControllerBase
    {
        ...
        public ActionResult GetCustomerDetails(int nEmpID, int nFnyearID)
        {
         ...
         SortedList Params = new SortedList();
            ...
            string sqlCommandEmployeeDetails = "select n_empID,X_EmpCode,X_EmpName,x_EmpNameLocale,x_Position,x_PositionLocale,d_HireDate,x_Department,n_ReportingToID,n_ReportToID,x_ReportTo,x_ReportingTo,x_Phone1 ,x_EmailID,x_ProjectName,i_Employe_Image from vw_PayEmployee where N_CompanyID=@p1 and N_FnYearID=@p2 and N_EmpID=@p3";
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sqlDOUT = "SELECT CASE WHEN D_Act_Shift2_Out='00:00:00.0000000' THEN D_Act_Shift1_Out else D_Act_Shift2_Out END AS D_Out from Pay_TimeSheetImport  where N_EmpID=@p3 and D_Date=@today and N_CompanyID=@p1 order by N_SheetID desc";
