...
namespace SmartxAPI.Controllers
{
    ...
    public class Pay_JobTitle : ControllerBase
    {
        ...
        public ActionResult GetJobTitle()
        {
            ...
            string sqlCommandText = "Select N_CompanyID,N_PositionID,N_EmpID,N_SalaryGradeID,B_Edit,Code,Description,X_GradeCode,X_Gradename from vw_PayPosition_DispAdvanced Where N_CompanyID=@nCompanyID Group By N_CompanyID,N_PositionID,N_EmpID,N_SalaryGradeID,B_Edit,Code,Description";
            try
            {
