...
namespace SmartxAPI.Controllers
{
    ...
    public class Pay_TimeSheetEdit : ControllerBase
    {
        ...
        public ActionResult GetEmpList(int nFnYearID, DateTime dtpSalaryFromdate, DateTime dtpSalaryToDate, bool b_AllBranchData, int nBranchID,DateTime dDate)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
