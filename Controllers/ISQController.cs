...

{
    ...
    [ApiController]
    public class ISQController : ControllerBase
    {
        private readonly ISQRepo _repository;
        private readonly IMapper _mapper;
        private readonly IConfiguration _config;
        private readonly IDataAccessLayer _dataAccess;

        
        public ISQController(ISQRepo repository, IMapper mapper,IDataAccessLayer dataaccess)
        {
