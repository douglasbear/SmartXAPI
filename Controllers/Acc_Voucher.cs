                    ...
                    if (xVoucherNo == "@Auto")
                    {
                        ...
                        while (true)
                        {
                           ...
                           xButtonAction="Insert"; 
                            object N_Result = dLayer.ExecuteScalar("Select 1 from Acc_VoucherMaster Where X_VoucherNo ='" + xVoucherNo + "' and N_CompanyID= " + nCompanyId + " and X_TransType ='" + xTransType + "'", connection, transaction);
                            if (N_Result == null)
                                break;
                        }
                        if (xVoucherNo == "")
