                ...
                using (SqlConnection Con = new SqlConnection(connectionString))
                {
                    ...
                    if (nSalesOrderID > 0 || (xSalesOrderID != "" && xSalesOrderID != null))
                    {
                        ...
                        if (nSalesOrderID > 0)
                        {
                            ...
                            RentalSql = "SELECT * FROM  vw_RentalScheduleItems  Where N_CompanyID=@nCompanyID and N_TransID=@nSalesorderID and N_FormID=1571 and B_Select=1 order by N_ScheduleID asc";
