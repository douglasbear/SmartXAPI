...
namespace SmartxAPI.Controllers
{
    ...
    [Route("employeeloanrequest_trash")]
    [ApiController]



    public class Ess_EmployeeLoanRequest_trash : ControllerBase
    {
        ...
        public Ess_EmployeeLoanRequest_trash(IDataAccessLayer dl, IApiFunctions _api, IMyFunctions myFun, IConfiguration conf)
        {
            dLayer = dl;
            api = _api;
            myFunctions = myFun;
