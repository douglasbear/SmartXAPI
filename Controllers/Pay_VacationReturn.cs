    ...
    public class Pay_VacationReturn : ControllerBase
    {
        ...
        public ActionResult GetVacationList(int nBranchID, bool bAllBranchData, int nEmpID)
        {
            ...
            string sqlCommandText = "Select vw_PayVacationEmployee.[Employee Code] AS X_EmpCode, vw_PayVacationEmployee.Name AS X_Emp_Name, vw_PayVacationEmployee.N_VacationGroupID, vw_PayVacationEmployee.X_VacationGroupCode, " +
                        " vw_PayVacationEmployee.X_VacType, vw_PayVacationEmployee.N_EmpID, vw_PayVacationEmployee.N_Status, vw_PayVacationEmployee.N_VacationID " +
            ...
            try
            {
                ...
                {
                    connection.Open();
                    sqlCommandText = "select X_EmpCode,X_Emp_Name,N_VacationGroupID,N_VacationID,X_VacationGroupCode,X_VacType,N_EmpID,N_Status from (" + sqlCommandText + ") as dt group by X_EmpCode,X_Emp_Name,N_VacationGroupID,N_VacationID,X_VacationGroupCode,X_VacType,N_EmpID,N_Status";
                    ...
                    {
                        DataTable VacDate = dLayer.ExecuteDataTable("Select Min(D_VacDateFrom) As FromDate ,Max(D_VacDateTo) as ToDate, B_ProcessAdvSalary from Pay_VacationDetails Where N_VacationID =" + var["N_VacationID"].ToString() + " group by B_ProcessAdvSalary", connection);
