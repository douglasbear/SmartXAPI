        ...
        public ActionResult TaskList(int nMenuID)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    "B_IsDefault as isDefault,B_SearchEnabled as searchEnabled,B_AttachementSearch as attachementSearch,X_PKey,N_Type,N_Order,X_PCode,N_UserID,X_TotalField,isnull(B_IsCustomList,0) as B_IsCustomList,X_DefaultSearchField as defaultsearch from " +
