...
//         }
//         [HttpGet("details")]
//         public ActionResult GetDashboardDetails(int nAcYearID,int nBranchID,bool bAllBranchData)
//         {
...
//             string sqlExam = "SELECT COUNT(*) as N_Count FROM vw_SchAdmission WHERE x_Gender='Male' and  N_CompanyID = " + nCompanyID + " and  N_AcYearID="+nFnYearID  + crieteria ;
//             string sqlAbsent = "SELECT COUNT(*) as N_Count FROM vw_SchAdmission WHERE x_Gender='FeMale' and N_CompanyID = " + nCompanyID + " and  N_AcYearID="+nFnYearID  + crieteria ;
