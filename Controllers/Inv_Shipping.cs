...
namespace SmartxAPI.Controllers
{
      ...
      public class Inv_Shipping : ControllerBase
    {
        ...
        [HttpGet("details")]
        public ActionResult ShippingInvoiceDetails(string xShippingCode, bool bAllBranchData, int nFnYearID, int nDeliveryNoteId, string xDeliveryNoteID, int nFormID, int nBranchId, string xInvoiceNo)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    int N_ShippingID = myFunctions.getIntVAL(MasterTable.Rows[0]["N_ShippingID"].ToString());
                    Params.Add("@p3", N_ShippingID);

                    string DetailSql = "select * from VW_Inv_Shipping_details where N_CompanyID=@p1 and N_ShippingID=@p3";
                    ...
                    dt.Tables.Add(DetailTable);
                     ...
                     int N_CustomerID = myFunctions.getIntVAL(DetailTable.Rows[0]["N_CustomerID"].ToString());
                    ...
                    if (nDeliveryNoteId > 0 || (xDeliveryNoteID != "" && xDeliveryNoteID != null))
                    {
                        ...
                        if (nDeliveryNoteId > 0)
                        {
                            ...
                            Mastersql = "select * from vw_DeliveryNoteToShippingMaster where N_CompanyId=@nCompanyID and N_DeliveryNoteId=@nDeliveryNoteID";
                        ...
                        // string DetailSql = "";
                        //  DetailSql = "select * from vw_DeliveryNoteToShippingDetails where N_CompanyId=@nCompanyID and N_DeliveryNoteID=@nDeliveryNoteID ";
