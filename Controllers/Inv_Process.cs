...
//         }
//         [HttpGet("details")]
//         public ActionResult ListDetails(string xReferenceNo)
//         {
...
//                     Master = dLayer.ExecuteDataTable(_sqlQuery, QueryParamsList, connection);


//                     string qry = "select N_Qty from Inv_ItemUnit inner join Inv_ItemMaster on Inv_ItemUnit.N_ItemUnitID=Inv_ItemMaster.n_BOMUnitID  where Inv_ItemMaster.N_ItemID=" + N_ItemID + " and Inv_ItemUnit.N_CompanyID=" + myCompanyID._CompanyID + " and Inv_ItemUnit.N_ItemUnitID=" + N_BOMUnitId;
