...

{
    ...
    public class Inv_SalesQuotation : ControllerBase
    {
        ...
        [HttpGet("list")]
        public ActionResult GetSalesQuotationList(int? nCompanyId, int nFnYearId,int nListID)
        {
