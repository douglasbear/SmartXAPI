    ...
    public class Inv_GoodsReceiveNote : ControllerBase
    {
        ...
        public ActionResult GetGoodsReceiveList(int? nCompanyId, int nFnYearId, int nPage, int nSizeperpage, string xSearchkey, string xSortBy,bool bAllBranchData,int nBranchID)
        {
            ...
            if (xSearchkey != null && xSearchkey.Trim() != "")
                ...
                Searchkey = "and ([MRN No] like '%" + xSearchkey + "%' or X_VendorName like '%" + xSearchkey + "%' or x_InvoiceNo like '%" + xSearchkey + "%' or X_VendorInvoice like '%" + xSearchkey +"%' or x_Description like '%" + xSearchkey + "%' )";
