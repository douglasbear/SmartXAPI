...
//                                 string sql7 = "Select * From vw_EmpGrp_Workhours Where N_CompanyID = " + nCompanyID + " and N_PkeyId = " + myFunctions.getIntVAL(TimeSheetMaster.Rows[0]["N_CatagoryId"].ToString()) + "";
...
//                                                         }
//                                                     }
//                                                     if ((row["mcRemarks"] == "" || row["mcRemarks"] == null) && row["Attandance"] != "P")
//                                                     {
