...
namespace SmartxAPI.Controllers
{
    ...
    public class SalesDashboard : ControllerBase
    {
        ...
        public ActionResult GetDashboardDetails(int nFnYearID,int nBranchID,bool bAllBranchData)
        {
            ...
            string sqlMonthlySales = " select D_Start,X_Month, sum (N_SaleOrderAmt)AS N_SalesOrderAmt,sum (N_SalesAmt)AS N_SalesAmt,sum (N_PaidAmt)AS N_PaidAmt from vw_MonthBranchWiseSalesAmt  where  N_CompanyID = " + nCompanyID  + " and N_FnyearID="+nFnYearID + crieteria + " group by D_Start,X_Month ";
